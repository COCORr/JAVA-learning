...
public class Employee implements java.io.Serializable {
    ...
    public transient int age; // transient瞬态修饰成员,不会被序列化 反序列化时为0
...
## 3.2 ObjectInputStream类 （读取时为obj，需要强制转换）
...
public class Employee implements java.io.Serializable {
     // 加入序列版本号
     private static final long serialVersionUID = 1L; //重要！！！序列号
     public String name;
     public String address;
